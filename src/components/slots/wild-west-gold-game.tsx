...
export function WildWestGoldGame() {
  const [bet, setBet] = useBetAmount(10, "wild-west-gold-bet");
  ...
  const onSpin = async () => {
    ...
    const result = await play("wild-west-gold", {}, toRaw(bet));
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-4">
      <div className="relative flex flex-col items-center justify-center p-8 bg-gradient-to-b from-lime-800 to-emerald-950 rounded-xl border border-[#2f4553] min-h-[400px] overflow-hidden">
        {winAmount && !spinning && (
